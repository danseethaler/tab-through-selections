...
import TabThroughSelections from '../lib/tab-through-selections';
...
describe('TabThroughSelections', () => {
  let workspaceElement, activationPromise;

  beforeEach(() => {
    workspaceElement = atom.views.getView(atom.workspace);
    activationPromise = atom.packages.activatePackage('tab-through-selections');
  });

  describe('when the tab-through-selections:toggle event is triggered', () => {
